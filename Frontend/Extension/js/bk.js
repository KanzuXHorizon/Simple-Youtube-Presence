...
window.onload = async function() {
    ...
    function connect() {
        ...
        Ws_Server.onclose = function() {
            ...
            console.log(interval_a,interval_b,pinginterval)
    ...
    function CheckIfSame() {
        ...
        switch (!last_href) {
            ...
            case false: {
                return final = last_href == location.href
            }
        }
        return final;
    }
    ...
    async function Get_Data() {
        ...
        //document.querySelector("#movie_player > div.html5-video-container > video").onload 
